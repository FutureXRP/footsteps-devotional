...
export const SERIES: Series[] = [
  ...
  },
  {
    ...
    sections: [
      { index: 1, title: 'The Awakening', subtitle: 'The burden and the cross', range: [1, 25], colors: { badge: '#FBEEE6', text: '#7A3B1A', border: '#D9783E', dot: '#D9783E' } },
      { index: 2, title: 'The Great Surrender', subtitle: 'My utmost for His highest', range: [26, 55], colors: { badge: '#F7E7EA', text: '#7A1F33', border: '#C04A63', dot: '#C04A63' } },
      { index: 3, title: 'The Love of the Father', subtitle: 'Adopted, held, abiding', range: [56, 85], colors: { badge: '#FBF0D8', text: '#6B4A12', border: '#D8A12F', dot: '#D8A12F' } },
      { index: 4, title: 'The Means of Grace', subtitle: 'The disciplines of the heart', range: [86, 120], colors: { badge: '#E7F2E5', text: '#2C5125', border: '#5C9A4D', dot: '#5C9A4D' } },
      { index: 5, title: 'Pathways to God', subtitle: 'How you draw near', range: [121, 145], colors: { badge: '#E0F1F0', text: '#13524E', border: '#2E8F86', dot: '#2E8F86' } },
      { index: 6, title: 'The Interior Castle', subtitle: 'The mansions of the soul', range: [146, 175], colors: { badge: '#E8E7F8', text: '#322A78', border: '#6A5CC0', dot: '#6A5CC0' } },
      { index: 7, title: "The Tempter's Strategy", subtitle: 'The enemy of your formation', range: [176, 205], colors: { badge: '#E9EDF1', text: '#33424F', border: '#5E7689', dot: '#5E7689' } },
      { index: 8, title: 'The Dark Night & the Valley', subtitle: 'When God seems absent', range: [206, 235], colors: { badge: '#E5E6F2', text: '#2A2C66', border: '#4C50A8', dot: '#4C50A8' } },
      { index: 9, title: 'The Death of Self', subtitle: 'Losing your life to find it', range: [236, 265], colors: { badge: '#F1ECE3', text: '#594328', border: '#9B7C4C', dot: '#9B7C4C' } },
      { index: 10, title: 'Christ Formed in You', subtitle: 'The fruit of the Spirit', range: [266, 295], colors: { badge: '#E1F4EA', text: '#0E5238', border: '#1F9468', dot: '#1F9468' } },
      { index: 11, title: 'Formed Together', subtitle: 'No one is formed alone', range: [296, 320], colors: { badge: '#F8E9E5', text: '#7A3322', border: '#C66049', dot: '#C66049' } },
      { index: 12, title: 'The Active Life', subtitle: 'Contemplation in action', range: [321, 340], colors: { badge: '#FBEFD9', text: '#6B4410', border: '#E0A02C', dot: '#E0A02C' } },
      { index: 13, title: 'The Celestial City', subtitle: 'The end of the pilgrimage', range: [341, 365], colors: { badge: '#EFEAF7', text: '#43306E', border: '#8366C0', dot: '#8366C0' } },
    ],
  },
]
